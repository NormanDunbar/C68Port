...
{
    printf("\nTEST FILE: %s\n\n", __FILE__);
    printf("This test creates a LOCal FLOAT, with a value, and displays its details.\n\n");
    ...
    printf("of the variable should be 12345.678 and displayed twice.\n\n");
    test_1();
    printf("\nTest complete.\n\n");
}
...
/* Function to create a single new scope. */
 void test_1() {
    ...
    SET_LOCAL_FLOAT("testLocal", 12345.678);
